				...
				<div class="container-fluid">
					<div class="main-header-left ">
						<div class="responsive-logo">
							<a href="{{ url('/' . $page='home') }}"><img src="{{URL::asset('assets/img/brand/fatora.png')}}" class="logo-1" alt="logo"></a>
							<a href="{{ url('/' . $page='home') }}"><img src="{{URL::asset('assets/img/brand/fatora.png')}}" class="dark-logo-1" alt="logo"></a>
							<a href="{{ url('/' . $page='home') }}"><img src="{{URL::asset('assets/img/brand/Fatora-22-.png')}}" class="logo-2" alt="logo"></a>
							<a href="{{ url('/' . $page='home') }}"><img src="{{URL::asset('assets/img/brand/Fatora-22-.png')}}" class="dark-logo-2" alt="logo"></a>
						</div>
								...
								<div class="dropdown-menu">
									<div class="menu-header-content bg-primary text-right">
										<div class="d-flex">
                                            ...
                                            <a class="badge badge-pill badge-warning mr-auto my-auto float-left" href="{{route('mark_all_as_read')}}"> تحديد الكل كمقروءة </a>
                                        </div>
										<p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12  " id="notifications_count">لديك {{count(auth::user()->unreadNotifications)}}  اشعار غير مقروء</p>
									</div>
									<div class="main-notification-list Notification-scroll" id="unreadNotifications">
                                         @foreach ( auth::user()->unreadNotifications as $noti )

									    	<a class="d-flex p-3 border-bottom" href="{{ route('invd', $noti->data['id'])}}">
											<div class="mr-3">
											<h5 class="notification-label mb-1" > {{$noti->data['title']}} {{$noti->data['user']}}</h5>

												<div class="notification-subtext">{{$noti->created_at}}</div>
											</div>
                                            @endforeach
