<!-- main-sidebar -->
		...
		<aside class="app-sidebar sidebar-scroll">
			<div class="main-sidebar-header active">
				<a class="desktop-logo logo-light active"  href="{{ url('/' . $page='home') }}"><img src="{{URL::asset('assets/img/brand/fatora.png')}}" class="main-logo" alt="logo"  style="  width: 550px; height: auto; margin-top: -15px; " ></a>
				<a class="desktop-logo logo-dark active" href="{{ url('/' . $page='home') }}"><img src="{{URL::asset('assets/img/brand/fatora.png')}}" class="main-logo dark-theme" alt="logo"></a>
				<a class="logo-icon mobile-logo icon-light active" href="{{ url('/' . $page='index') }}"><img src="{{URL::asset('assets/img/brand/Fatora-222-.png')}}" class="logo-icon" alt="logo"></a>
				<a class="logo-icon mobile-logo icon-dark active" href="{{ url('/   ' . $page='index') }}"><img src="{{URL::asset('assets/img/brand/fatora.png')}}" class="logo-icon dark-theme" alt="logo"></a>
			</div>
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					...
					<li class="slide">
					    ...
					    <li class="slide">
					    	<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M19 5H5v14h14V5zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z" opacity=".3"/><path d="M3 5v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2H5c-1.1 0-2 .9-2 2zm2 0h14v14H5V5zm2 5h2v7H7zm4-3h2v10h-2zm4 6h2v4h-2z"/></svg><span class="side-menu__label"> اقسام الفواتير</span><i class="angle fe fe-chevron-down"></i></a>

                          <ul class="slide-menu">
                              @can('كل الفواتير')
                                  <li><a class="slide-item" href="{{ url('/' . $page='invoices') }}">كل الفواتير</a></li>
                              @endcan

                                @can('الفواتير المدفوعة')
						    	    <li><a class="slide-item" href="{{ url('/' . $page='paid_inv') }}">الفواتير المدفوعة</a></li>
                                @endcan

                                @can('الفواتير غير المدفوعة')
                                  <li><a class="slide-item" href="{{ url('/' . $page='unpaid_inv') }}">الفواتير غير المدفوعة</a></li>
                                @endcan

                                @can('الفواتير المدفوعة جزئيا')
                                  <li><a class="slide-item" href="{{ url('/' . $page='partly_paid_inv') }}">الفواتير المدفوعة جزئيا</a></li>
                                @endcan
                    ...
                    <li class="side-item side-item-category">البيانات</li>
					...
					<li class="slide">
						...
						<ul class="slide-menu">
                             ...
                             @can('تقرير العملاء')
                                <li><a class="slide-item" href="{{ url('/' . $page='clients_report') }}">تقارير العملاء</a></li>
                             @endcan
						</ul>
					</li>
