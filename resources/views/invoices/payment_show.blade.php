...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">تغير حالة الدفع</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/
                   {{$invoices->invoice_number}}</span>
            </div>
        </div>
...
@section('content')
 ...
 <div class="row">
    <div class="col-lg-12 col-md-12">
        <div class="card">
            <div class="card-body">
                <form action="{{ route('payment.change', ['id' => $invoices->id]) }}" method="post" autocomplete="off">
                    {{ csrf_field() }}
                    {{-- 1 --}}
                    <div class="row">
                        <div class="col">
                      ...
                      <div class="row">
                        <div class="col">
                            ...
                            <input type="hidden" name="section_id" value="{{$invoices->sections->id}}">
                            <input type="text" class="form-control" id="inputName" name="sections"
                                title="يرجي ادخال رقم الفاتورة" value="{{ $invoices->sections->section_name}}" required
                                readonly>
                        </div>

                        <div class="col">
                            <label for="inputName" class="control-label">المنتج</label>
                            <input type="text" id="product" name="product" value="{{ $invoices->product }}" class="form-control" readonly>
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <input name="Rate_VAT" id="Rate_VAT" value=" {{ $invoices->Rate_VAT }}" class="form-control" onchange="myFunction()" readonly>
