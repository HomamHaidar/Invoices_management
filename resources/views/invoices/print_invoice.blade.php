...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">طباعة الفاتورة</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/
								...
								<div class="card-body">
									...
									<div class="row mg-t-20">
										...
										<div class="col-md">
											...
											<p class="invoice-info-row"><span>الحالة:</span> <span> {{$invoice->Status}}</span></p>
										...
										<table class="table table-invoice border text-md-nowrap mb-0">
											...
											<tbody>
												...
												<tr>
													...
													<td class="tx-12">{{$invoice->note}}</td>
													...
													<td class="tx-right">
                                                        {{number_format($invoice->Amount_collection+$invoice->Amount_Commission,2)}}
                                                    </td>
												</tr>
												<tr>
