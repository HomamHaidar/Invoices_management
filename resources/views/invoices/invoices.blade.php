                        ...
                        <div class="row row-xs wd-xl-60p">
                            ...
                            @can('اضافة فاتورة')
                                <div class="col-sm-6 col-md-3">
                                    ...
                                    <a href="invoices/create"class="btn btn-primary-gradient btn-block" style="color:white">
                                        <i
                            ...
                            @can('Excel')
                                <div class="col-sm-6 col-md-3 mg-t-10 mg-sm-t-0">
                                    <a href="export_invoices"class="btn btn-success-gradient btn-block" style="color:white">
                                        <i
                                            class="fas fa-file"></i>&nbsp; Excel</a>
                                </div>
                            @endcan
                        </div>
                    </div>
