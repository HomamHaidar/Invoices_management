                    ...
                    <div class="d-flex justify-content-between">
                      @can('اضافة منتج')
                            <div class="col-sm-6 col-md-3">
                                <button class="btn btn-primary-gradient btn-block" data-effect="effect-scale"  data-toggle="modal" href="#exampleModal" >اضافة منتج</button>
                            </div>
                      @endcan
                            ...
                            @foreach ($products as $Product)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @can('حذف منتج')
                                            <button class="btn btn-danger-gradient btn-block" data-pro_id="{{ $Product->id }}"
