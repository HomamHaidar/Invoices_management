    ...
    <div class="row row-sm">
            ...
            <div class="card">
                <div class="card-header bg-transparent pd-b-0 pd-t-20 bd-b-0">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mb-0">توزيع الفواتير</h4>
                    </div>
                    <p class="tx-12 text-muted mb-0">المخطط التالي يبين نسبة المستحقات من الفواتير  </p>
                </div>
                <div class="card-body">
                    {!! $chartjs->render() !!}
                </div>
        ...
        <div class="col-lg-12 col-xl-5">
            <div class="card card-dashboard-map-one">
                <label class="main-content-label">توزيع الفواتير</label>
                <span class="d-block mg-b-20 text-muted tx-12">المخطط التالي يبين نسبة المستحقات من الفواتير</span>
                <div class="card-body">
                        {!! $chartjs2->render() !!}
